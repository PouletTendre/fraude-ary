...
from app.routers import auth, assets, portfolio, prices, demo, alerts, notifications, exchange_rates, cache, monitoring, transactions, dividends, simulator, technical, analytics, news, valuation, plaid
